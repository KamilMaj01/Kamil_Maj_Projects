...
//		cnt++;
//		TX_size = snprintf(buffor_tx,sizeof(buffor_tx),"Kolejny: %d\n",cnt);
//		HAL_UART_Transmit_DMA(huart, buffor_tx, TX_size);
//
//	}
//}

// Funkcja odpowiedzilna za obsłużenie przerwania związanego z transmisją Portu szeregowego (UART2)
...
// Funkcja odpowiedzialna za obsłużenie przerwania związanego z ADC
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc){
